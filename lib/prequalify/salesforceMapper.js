...
const LEAD_FIELD_MAP = Object.freeze([
  ...
  // --- previousAddress: `accionDireccionAnterior.php:167-177` -------------
  // Van en el propio Lead, con sufijo `2`. Ojo: el legacy NO pasa a mayusculas
  // `street2__c` aunque si lo haga con `Street`; se respeta la asimetria para
  // no divergir de los datos existentes.
  { path: 'previousAddress.line1', sf: 'street2__c', cite: 'accionDireccionAnterior.php:171' },
  { path: 'previousAddress.unit', sf: 'unit2__c', cite: 'accionDireccionAnterior.php:172' },
  { path: 'previousAddress.city', sf: 'cbocity2__c', cite: 'accionDireccionAnterior.php:169' },
  { path: 'previousAddress.state', sf: 'cbostate2__c', cite: 'accionDireccionAnterior.php:168' },
  { path: 'previousAddress.zipCode', sf: 'zip2__c', cite: 'accionDireccionAnterior.php:170' },
  {
    path: 'previousAddress.years',
    sf: 'yearsCurrentAddress2__c',
    to: toNumberOrUndefined,
    cite: 'accionDireccionAnterior.php:173',
  },
  {
    path: 'previousAddress.months',
    sf: 'monthsCurrentAddress2__c',
    to: toNumberOrUndefined,
    cite: 'accionDireccionAnterior.php:174',
  },
  // TODO(Roberto): el legacy tampoco pasa a mayusculas `Housing2__c`, mientras
  // que `Housing1__c` si. Como el paso de direccion anterior era inalcanzable
  // en el wizard (ver `stateMachine.js`, nota OPTIONAL_STEPS), no hay datos
  // reales con los que decidir. Se replica el legacy: sin `strtoupper()`.
  { path: 'previousAddress.housing', sf: 'Housing2__c', cite: 'accionDireccionAnterior.php:175' },
  {
    path: 'previousAddress.rentMonth',
    sf: 'rentMonth2__c',
    to: toNumberOrUndefined,
    cite: 'accionDireccionAnterior.php:176',
  },
 ...
 *   (`{ email, phone, ..., currentAddress: {...}, previousAddress: {...} }`)
 ...
 * `previousAddress`, `mailingAddress`, `coborrower`, `otpVerify`.
