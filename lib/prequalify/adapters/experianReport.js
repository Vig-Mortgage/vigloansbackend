...
function createExperianAdapter({
  ...
  // SOLO `fetchCreditReport`. El objeto que se devuelve ES el puerto, y
  // `createPorts` rechaza cualquier clave que no este en su contrato — con
  // razon: un puerto con metodos de mas deja de ser sustituible. Exponer aqui
  // un `_entorno` de conveniencia tumbo el montaje entero en el despliegue del
  // 2026-08-07, asi que el entorno se deja en el log y no en la interfaz.
  logger.info('prequalify.experian_adaptador', { entorno });
