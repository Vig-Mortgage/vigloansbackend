...
const DocumentKind = Object.freeze({
  ...
  /** Talonario de pago. */
  PAYSTUB: 'paystub',
  /** Todo lo demas: planillas, Form 1099-R, evidencia suelta. */
  OTHER: 'other',
});
 ...
 *
 * TODO(Roberto): el puerto solo admite `licence|paystub|other`, asi que hoy
 * planillas y Form 1099-R caen ambos en `other` y no se distinguen en la clave.
 * Si en Salesforce hay que diferenciarlos, hay que ampliar el enum del puerto
 * (`taxes`, `form1099r`) antes de que se suban documentos en produccion:
 * despues implica renombrar objetos ya existentes.
 */
 ...
 * @param {'licence'|'paystub'|'other'} input.kind
